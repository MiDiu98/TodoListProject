package com.ungmydieu.todolist.exceptions;
...
public class GlobalControllerException {
    public ResponseEntity<ErrorModel> handleException(NotFoundException ex, ServletWebRequest request) {
        return new ResponseEntity<>(new ErrorModel(ex.getMessage(), request.getRequest().getContextPath()), HttpStatus.NOT_FOUND);
    }
}
